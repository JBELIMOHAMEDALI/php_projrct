...
<body id="page-top"> 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Add Taugh</h1>
                    <form class="user" >
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name = "libelle_enseigne"  id="libelle_enseigne" 
                                            placeholder="Name">
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" name = "url" id="url"
                                            placeholder="Url">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" name = "nom_boutique"  id="nom_boutique" 
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" name = "tel_boutique" id="tel_boutique"
                                        placeholder="Phone Shop">
                                </div>
 ...
 libelle_enseigne = document.getElementById("libelle_enseigne").value ;
    id_enseigne=document.getElementById("libelle_enseigne").value ;
...
nom_user = document.getElementById("libelle_enseigne").value = "";
    ...
    $.ajax({ 
      ...
      data: 
       {libelle_enseigne:libelle_enseigne,
        url:url,
